...
int main(int argc, char** argv) {
	...
	//printArray(N.elements);
	//printArray(P.elements);
...
{   
	...
	//launch kernel
	dim3 DimGrid(MATRIX_SIZE/BLOCK_SIZE,MATRIX_SIZE/BLOCK_SIZE,1);
    dim3 DimBlock(BLOCK_SIZE,BLOCK_SIZE,1);
    MatrixAddKernel<<<DimGrid,DimBlock>>>(Mdevice.elements,alpha,Ndevice.elements,beta,Pdevice.elements);
